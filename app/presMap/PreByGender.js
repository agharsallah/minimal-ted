...
class PreByGender extends Component{
	...
	function getColor (d)  {
	 ...
	 function style(feature) {
		    return {
		        fillColor: getColor(feature.properties.womenTurnout),
		        weight: 2,
		        opacity: 1,
		        color: 'white',
		        dashArray: '3',
    ...
    var info = L.control();
		...
		info.update = function (props) {
		    this._div.innerHTML = '<h4>Female Turnout per destrict</h4>' +  (props ?
		        '<b>' + props.NAME_EN + '</b><br/>' +'<h3>'+ props.womenTurnout + ': %'+'</h3>'
