...
class TestDraw extends Component{
	...
	L.tileLayer('https://api.mapbox.com/styles/v1/mapbox/streets-v10/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1IjoiaHVudGVyLXgiLCJhIjoiY2l2OXhqMHJrMDAxcDJ1cGd5YzM2bHlydSJ9.jJxP2PKCIUrgdIXjf-RzlA', {
    ...
    var geojson = L.geoJson(newDelegation, {style: style,onEachFeature: onEachFeature}).addTo(mymap);
